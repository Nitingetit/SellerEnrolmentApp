...
public class SchedulerSetupReceiver extends BroadcastReceiver {
	...
	private static final int EXEC_INTERVAL =43200000;
	...
	public void onReceive(final Context ctx, final Intent intent) {
		...
		now.add(Calendar.SECOND, 43200000);
//		Toast.makeText(ctx, "Inside the SchedulerSetupReceiver", Toast.LENGTH_SHORT).show();
